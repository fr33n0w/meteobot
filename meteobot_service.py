...
def parse_arguments():
    parser = argparse.ArgumentParser(description="LXMF Meteo Bot Configuration")
    parser.add_argument('--display_name', type=str, default="Meteo Bot - MSG ME!", help='Display name for the bot')
    parser.add_argument('--announce_time', type=int, default=300, help='Auto-announce time in seconds')
    parser.add_argument('--stamp_cost', type=int, default=0, help='Stamp cost value (1 to 256 to enable, 0 to disable)')
...
announce_time = args.announce_time
stamp_cost = args.stamp_cost

# Validate stamp cost
if stamp_cost < 0 or stamp_cost > 256:
    raise ValueError("Stamp cost must be between 0 and 256.")
...
# Initialize Reticulum Network Protocol
r = RNS.Reticulum()
